...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: '&Uacute;ltima Semana', dateStart: 'today-7days', dateEnd: 'today' },
			{text: '&Uacute;ltimo Mes', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: 'A&ntilde;o', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
		...
		presets: {
			specificDate: 'Fecha Espec&iacute;fica', 
			allDatesBefore: 'Antes de', 
			allDatesAfter: 'Después de', 
			dateRange: 'Rango de Fechas'
		},
		rangeStartTitle: 'Fecha Inicio',
		rangeEndTitle: 'Fecha Final',
		nextLinkText: 'Siguiente',
		prevLinkText: 'Anterior',
		doneButtonText: 'OK', 
		earliestDate: Date.parse('-15years'), //earliest date allowed 
		latestDate: Date.parse('+15years'), //latest date allowed 
		rangeSplitter: 'a', //string to use between dates in single input
